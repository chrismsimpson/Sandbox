...
public:
    ...
    void on_create()
    {
        m_mesh = Mesh::create_from_height_map(Mesh::generate_height_map(32));
        ...
        float elapsed)
    {
        ...
        if (m_mesh.has_value())
        {
            ...
            for (auto i = 0; i < m_mesh->triangles().size(); i++)
            {
                ...
                std::println("tri ({}): {},{},{} {},{},{} {},{},{}", i, tri.point_at(0).x(), tri.point_at(0).y(), tri.point_at(0).z(), tri.point_at(1).x(), tri.point_at(1).y(), tri.point_at(1).z(), tri.point_at(2).x(), tri.point_at(2).y(), tri.point_at(2).z());
                ...
                std::println("  transformed: {},{},{} {},{},{} {},{},{}", tri_transformed.point_at(0).x(), tri_transformed.point_at(0).y(), tri_transformed.point_at(0).z(), tri_transformed.point_at(1).x(), tri_transformed.point_at(1).y(), tri_transformed.point_at(1).z(), tri_transformed.point_at(2).x(), tri_transformed.point_at(2).y(), tri_transformed.point_at(2).z());
                ...
                if (Vec4::dot_product(normal, camera_ray) < 0.0f)
                {
                    ...
                    std::println("  viewed: {},{},{} {},{},{} {},{},{}", tri_viewed.point_at(0).x(), tri_viewed.point_at(0).y(), tri_viewed.point_at(0).z(), tri_viewed.point_at(1).x(), tri_viewed.point_at(1).y(), tri_viewed.point_at(1).z(), tri_viewed.point_at(2).x(), tri_viewed.point_at(2).y(), tri_viewed.point_at(2).z());
                    ...
                    for (auto n = 0; n < clipped_triangles; n++)
                    {
                        ...
                        std::println("  projected ({}): {},{},{} {},{},{} {},{},{}", n, tri_projected.point_at(0).x(), tri_projected.point_at(0).y(), tri_projected.point_at(0).z(), tri_projected.point_at(1).x(), tri_projected.point_at(1).y(), tri_projected.point_at(1).z(), tri_projected.point_at(2).x(), tri_projected.point_at(2).y(), tri_projected.point_at(2).z());
        ...
        for (const auto triangle_to_raster : triangles)
        {
            ...
            {
                std::println("  inner: {},{},{} {},{},{} {},{},{}", it.point_at(0).x(), it.point_at(0).y(), it.point_at(0).z(), it.point_at(1).x(), it.point_at(1).y(), it.point_at(1).z(), it.point_at(2).x(), it.point_at(2).y(), it.point_at(2).z());

...
public:
        ...
        const std::vector<float> &height_map)
    {
        ...
        for (auto y = 0; y < stride; y++)
        {
            for (auto x = 0; x < stride; x++)
            {
                ...
                const auto &c = Grid::color_given_heights(h1, h2, h3);
                ...
                const auto &c2 = Grid::color_given_heights(h4, h5, h6);
    ...
    void on_create()
    {
        ...
        m_mesh = Grid::create_from_height_map(Grid::generate_height_map(256));
